...
public class Turtle implements Runnable, ActionListener, MouseListener, MouseMotionListener, KeyListener, ComponentListener, MouseWheelListener
{
    ...
    {
        new Thread(new Bob(0,0,"red",600)).start();
        new Thread(new Bob(150, 150, "blue",300)).start();
        new Thread(new Bob(-125, 125, "green",150)).start();
        new Thread(new Bob(-100, 85, "brown",450)).start();
        new Thread(new Bob(-154, 87, "purple",1000)).start();
        new Thread(new Bob(32, 65, "yellow",600)).start();
        new Thread(new Bob(100, 34, "orange",300)).start();
        new Thread(new Bob(-43, 54, "black",200)).start();
        new Thread(new Bob(-65, 87, "lotus",100)).start();
        new Thread(new Bob(-76, 98, "black",50)).start();
    }
